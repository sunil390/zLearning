...
│    .vectors         │         1028 │     6.27 │                │               │
└─────────────────────┴──────────────┴──────────┴────────────────┴───────────────┘
Total image size: 951023 bytes (.bin may be padded larger)
Note: The reported total sizes may be smaller than those in the technical reference manual due to reserved memory and application configuration. The total flash size available for the application is not included by default, as it cannot be reliably determined due to the presence of other data like the bootloader, partition table, and application partition size.
RAM:   [==        ]  15.7% (used 51324 bytes from 327680 bytes)
Flash: [=====     ]  51.8% (used 950767 bytes from 1835008 bytes)
Building .pioenvs/radar-node/firmware.bin
Creating ESP32-S3 image...
Successfully created ESP32-S3 image.
Creating binary "firmware.factory.bin" with:
...
Info: radar-node.bin not found - skipping
Using FLASH_EXTRA_IMAGES from PlatformIO environment
Merging binaries into /home/zpi/config-nano-s3/.esphome/build/radar-node/.pioenvs/radar-node/firmware.factory.bin
Merging binaries with esptool
SHA digest in image updated.
Wrote 0xf8380 bytes to file '/home/zpi/config-nano-s3/.esphome/build/radar-node/.pioenvs/radar-node/firmware.factory.bin', ready to flash to offset 0x0.
Successfully created /home/zpi/config-nano-s3/.esphome/build/radar-node/.pioenvs/radar-node/firmware.factory.bin
esp32_copy_ota_bin([".pioenvs/radar-node/firmware.bin"], [".pioenvs/radar-node/firmware.elf"])
Copied firmware to /home/zpi/config-nano-s3/.esphome/build/radar-node/.pioenvs/radar-node/firmware.ota.bin
========================================== [SUCCESS] Took 730.18 seconds ==========================================
Using Python 3.11.2 environment at: /home/zpi/.platformio/penv/.espidf-5.5.4
INFO Build Info: config_hash=0x80bca4f9 build_time_str=2026-06-12 01:46:22 +0530
INFO Successfully compiled program.
esptool v5.2.0
Connected to ESP32-S3 on /dev/ttyACM0:
Chip type:          ESP32-S3 (QFN56) (revision v0.2)
...
Flash will be erased from 0x00010000 to 0x000f8fff...
Wrote 951168 bytes (635374 compressed) at 0x00010000 in 6.1 seconds (1253.6 kbit/s).
Hash of data verified.
SHA digest in image updated.
Flash will be erased from 0x00000000 to 0x00005fff...
Wrote 20864 bytes (13356 compressed) at 0x00000000 in 0.2 seconds (703.1 kbit/s).
Hash of data verified.
Flash will be erased from 0x00008000 to 0x00008fff...
Wrote 3072 bytes (161 compressed) at 0x00008000 in 0.0 seconds (937.1 kbit/s).
Hash of data verified.
Flash will be erased from 0x00009000 to 0x0000afff...
Wrote 8192 bytes (47 compressed) at 0x00009000 in 0.1 seconds (1229.5 kbit/s).
Hash of data verified.

Hard resetting via RTS pin...
INFO Successfully uploaded program.
INFO Starting log output from /dev/ttyACM0 with baud rate 115200
[16:59:53.942][D][wifi:1458]: Found networks:
[16:59:53.944][I][wifi:1429]: - 'AX55' (F0:2F:74:EB:0A:78) ▂▄▆█ Ch: 8 -63dB P:0
[16:59:53.945][D][wifi:1852]: Retry phase: INITIAL_CONNECT → SCAN_CONNECTING
[16:59:53.946][I][wifi:1097]: Connecting to 'AX55' (F0:2F:74:EB:0A:78) (priority 0, attempt 1/2 in phase SCAN_CONNECTING)...
[16:59:58.386][I][wifi:1570]: Connected
[16:59:58.387][D][wifi:1587]: Disabling AP
[16:59:58.388][C][wifi:1237]:   IP Address: 192.168.2.220
[16:59:58.389][C][wifi:1248]:   SSID: 'AX55'
[16:59:58.389][C][wifi:1248]:   BSSID: F0:2F:74:EB:0A:78
[16:59:58.390][C][wifi:1248]:   Hostname: 'radar-node'
[16:59:58.390][C][wifi:1248]:   Signal strength: -60 dB ▂▄▆█
[16:59:58.390][C][wifi:1248]:   Channel: 8
[16:59:58.391][C][wifi:1248]:   Subnet: 255.255.255.0
[16:59:58.391][C][wifi:1248]:   Gateway: 192.168.2.1
[16:59:58.391][C][wifi:1248]:   DNS1: 192.168.2.1
[16:59:58.391][C][wifi:1248]:   DNS2: 0.0.0.0
[16:59:58.408][I][mqtt:307]: Connecting
[16:59:58.413][W][component:422]: wifi cleared Warning flag
[16:59:58.631][W][component:422]: mqtt cleared Warning flag
[16:59:58.632][I][mqtt:348]: Connected
[16:59:58.737][W][component:522]: mqtt took a long time for an operation (108 ms), max is 30 ms
[17:00:49.668][I][safe_mode:142]: Boot seems successful; resetting boot loop counter
[17:00:52.187][D][preferences:148]: Writing 1 items: 0 cached, 1 written, 0 failed
```