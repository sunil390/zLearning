...
/*           
 ...
 OGET '/work/DigiCertGlobalRootCA.crt' 'IBMUSER.TEAMS.CRTCA' BINARY
 RACDCERT ADD('IBMUSER.TEAMS.CRTCA') CERTAUTH TRUST WITHLABEL('DigiCert Global Root CA')
 RACDCERT ADDRING(TEAMS)
 RACDCERT CONNECT(CERTAUTH LABEL('DigiCert Global Root CA') RING(TEAMS))
 * Specify where we can find the Certificate Authority (CA)             
 * certificates when we are connecting to Teams.                        
 * keyStore = 'SAF'  : Use SAF keyrings                                 
 */                                                                     
keyStore = 'SAF'                                                        
/*                                                                      
 * A key ring accessible by the user executing this Rexx script.        
 * Only used to validate the SSL certificate provided by Teams.         
 ...
 */                                                                    
 /* sslTraceFile = '/work/ssltrace.bin' */                             
sslTraceFile = ''                                                      
/*********************************************************************/
/*                                                                   */
