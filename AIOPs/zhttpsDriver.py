...
/* 003C = TLS_RSA_WITH_AES_128_CBC_SHA256                                 
 ...
 openssl x509 -in tls.crt -outform der -out nodered.der                   
 OGET '/work/DigiCertGlobalRootCA.crt' 'IBMUSER.TEAMS.CRTCA' BINARY       
 OGET '/u/SYSPRG1' 'IBMUSER.NODERED.CRT' BINARY                           
 RACDCERT ADD('IBMUSER.NODERED.CRT') CERTAUTH TRUST WITHLABEL('NR SS CA') 
 RACDCERT ADDRING(NODERED)                                                
 RACDCERT CONNECT(CERTAUTH LABEL('NR SS CA') RING(NODERED))               
